...
<div class="row">
    <form method='POST' action='{{ route("editarResultado", $resultado) }}' class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="inputValoresNormalidad" name="valores_normalidad" placeholder="Valores normalidad ..." value="{{ old('valores_normalidad', $resultado->valores_normalidad) }}">
        ...
        <div class="col-12">
            ...
            <a href="{{ route('resultados') }}" class="btn btn-danger">Cancelar</a>
        </div>
    </form>
</div>
@endsection