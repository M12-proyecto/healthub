...
@section('content')
            <div class="row align-items-center">
                <div class="col-xl-4">
                    <div class="card overflow-hidden info-card">
                        <div class="bg-primary-subtle info-card-header">
                            <div class="row">
                                <div class="col-7">
                        ...
                        <div class="card-body pt-0 info-card-body">
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="col-xl-8">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card mini-stats-wid mini-info-card">
                                <div class="card-body">
                                    <div class="d-flex">
