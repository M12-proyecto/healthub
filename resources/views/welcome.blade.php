...
<html lang="es">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{asset('img/faviconHealthHub2.ico')}}">

        <!-- Bootstrap Css -->
        
        <link href="@vite('resources/css/bootstrap.min.css')" id="bootstrap-style" rel="stylesheet" type="text/css"/>
        <!-- Icons Css -->
        <link href="@vite('resources/css/icons.min.css')" rel="stylesheet" type="text/css"/>
        <!-- App Css-->
        <link href="@vite('resources/css/app.min.css')" id="app-style" rel="stylesheet" type="text/css"/>
        <!-- App js -->
        <script src="@vite('resources/js/plugin.js')"></script>
    </head>
    ...
    <!-- component app -->
        ...
        <!-- JAVASCRIPT -->
        <script src="@vite('resources/js/libs/jquery.min.js')"></script>
        <script src="@vite('resources/js/libs/bootstrap.bundle.min.js')"></script>
        <script src="@vite('resources/js/libs/metisMenu.min.js')"></script>
        <script src="@vite('resources/js/libs/simplebar.min.js')"></script>
        <script src="a@vite('resources/js/libs/waves.min.js')"></script>

        <!-- apexcharts -->
        <script src="@vite('resources/js/libs/apexcharts.min.js')"></script>

        <!-- dashboard init -->
        <script src="@vite('resources/js/libs/dashboard.init.js')"></script>

        <!-- App js -->
        <script src="@vite('resources/js/libs/app.js')"></script>
    </body>
</html>